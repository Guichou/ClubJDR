<img id="gameLogo" src="images/starwarslogo.jpg" alt="image" width=450/>
<?php echo '<br/>Il était une fois, dans une galaxie lointaine, très lointaine...<br/><div id="isRed">NB : Ne sera sûrement pas joué à la rentrée </div>
	MJs : Stan et Gaël<br/><br/>';
	/* Pour afficher la liste des joueurs */
	$sql = 'SELECT * FROM repartition WHERE NOMJEU = "StarWars"';
	...
	<p>
		...
		<label for="jeu"></label><input type="hidden" name="jeu" id="jeu" value="StarWars" />
